        ...
        public async Task InvokeAsync(HttpContext context, IServiceProvider serviceProvider)
        {
            ...
            if (!productsService.Any())
            {
                ...
                var proletniRolca = new Product
                {
                    ...
                    Price = 2.70m,
                    Weight = 200,
                    Image = "https://www.dropbox.com/s/axa8nnf6bac10zf/01.jpg?raw=1",
                ...
                var paniraniZelenchuci = new Product
                {
                    ...
                    Price = 3.80m,
                    Weight = 300,
                    Image = "https://www.dropbox.com/s/r0r2ax7al6qtbjk/03.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Предястия").Id,
                };
                ...
                var salata = new Product
                {
                    ...
                    Price = 4.80m,
                    Weight = 300,
                    Image = "https://www.dropbox.com/s/6ysks28rw3ntxjg/09.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Предястия").Id,
                };
                products.Add(salata);
                var supaSkaridi = new Product
                {
                    ...
                    Price = 3.00m,
                    Weight = 300,
                    Image = "https://www.dropbox.com/s/fi3tk319lj9fm5g/26.jpg?raw=1",
                ...
                var supaVodorasli = new Product
                {
                    ...
                    Price = 2.30m,
                    Weight = 300,
                    Image = "https://www.dropbox.com/s/drla3ojeual1qvx/29.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Супи").Id,
                };
                ...
                var orizGuanDong = new Product
                {
                    ...
                    Price = 4.80m,
                    Weight = 800,
                    Image = "https://www.dropbox.com/s/7kmoch7lf6m4n3b/39.jpg?raw=1",
                ...
                var spagetiFenPile = new Product
                {
                    ...
                    Price = 6.80m,
                    Weight = 700,
                    Image = "https://www.dropbox.com/s/bnkeby96hu5yvqy/44.jpg?raw=1",
                ...
                var spagetiFenSvinsko = new Product
                {
                    ...
                    Price = 6.80m,
                    Weight = 700,
                    Image = "https://www.dropbox.com/s/6of3ubsnrk43azz/43.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Спагети Ми Фен").Id,
                };
                ...
                var pileUKsiang = new Product
                {
                    ...
                    Price = 9.20m,
                    Weight = 800,
                    Image = "https://www.dropbox.com/s/ithw2vi6e4a9xmz/69.jpg?raw=1",
                ...
                var osemte = new Product
                {
                    ...
                    Price = 13.80m,
                    Weight = 800,
                    Image = "https://www.dropbox.com/s/yl7ve3adsur5pqb/52.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Ястия с пилешко").Id,
                };
                products.Add(osemte);
                var spagetiPileZel = new Product
                {
                    ...
                    Price = 5.90m,
                    Weight = 750,
                    Image = "https://www.dropbox.com/s/s901j9y9vv893ec/48.jpg?raw=1",
                ...
                var spagetiTriVida = new Product
                {
                    ...
                    Price = 6.80m,
                    Weight = 750,
                    Image = "https://www.dropbox.com/s/z1h9bfzt4ztjxaw/50.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Ястия със спагети").Id,
                };
                ...
                var teleBambuk = new Product
                {
                    ...
                    Price = 9.80m,
                    Weight = 800,
                    Image = "https://www.dropbox.com/s/dstetvsbhfvetfu/70.jpg?raw=1",
                ...
                var praseU = new Product
                {
                    ...
                    Price = 9.20m,
                    Weight = 800,
                    Image = "https://www.dropbox.com/s/1kgd5vowqchawzn/80.jpg?raw=1",
                ...
                var rebra = new Product
                {
                    ...
                    Price = 10.80m,
                    Weight = 450,
                    Image = "https://www.dropbox.com/s/b77byqn0i985jsk/88.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Ястия със свинско").Id,
                };
                products.Add(rebra);
                var paticaTigan = new Product
                {
                    ...
                    Price = 12.30m,
                    Weight = 700,
                    Image = "https://www.dropbox.com/s/m87xaz4lh804tui/97.jpg?raw=1",
                ...
                var paticaPikant = new Product
                {
                    ...
                    Price = 11.30m,
                    Weight = 700,
                    Image = "https://www.dropbox.com/s/lgr4o86z1tll3jg/94.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Ястия със патешко").Id,
                };
                ...
                var kalmari = new Product
                {
                    ...
                    Price = 17.00m,
                    Weight = 400,
                    Image = "https://www.dropbox.com/s/h9k0nviciwrmxjq/105.jpg?raw=1",
                ...
                var skaridi = new Product
                {
                    ...
                    Price = 20.50m,
                    Weight = 400,
                    Image = "https://www.dropbox.com/s/o0a5xqf4s64zh88/108.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Морски деликатеси").Id,
                };
                ...
                var sladoled = new Product
                {
                    ...
                    Price = 3.00m,
                    Weight = 250,
                    Image = "https://www.dropbox.com/s/5fyq8amu157ck09/120.jpg?raw=1",
                ...
                var banan = new Product
                {
                    ...
                    Price = 2.70m,
                    Weight = 200,
                    Image = "https://www.dropbox.com/s/5yyccz17utg48mc/119.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Десерти").Id,
                };
                products.Add(banan);
                var plodove = new Product
                {
                    ...
                    Price = 2.80m,
                    Weight = 200,
                    Image = "https://www.dropbox.com/s/049r2sonlejudlz/116.jpg?raw=1",
                    CategoryId = categoriesService.FindByName("Десерти").Id,
                };
