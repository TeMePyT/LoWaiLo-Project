namespace LoWaiLo.WebAPI.Components
{
    ...
    public class NavbarBasketPanelComponent : ViewComponent
    {
        private readonly IShoppingCartService shoppingCartService;
        private readonly UserManager<ApplicationUser> userManager;

        public NavbarBasketPanelComponent(IShoppingCartService shoppingCartService, UserManager<ApplicationUser> userManager)
        {
