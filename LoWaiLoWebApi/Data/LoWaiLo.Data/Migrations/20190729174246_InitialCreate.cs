    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderAddon", x => new { x.OrderId, x.AddonId });
                    table.ForeignKey(
                        name: "FK_OrderAddon_Addons_AddonId",
                        column: x => x.AddonId,
                        principalTable: "Addons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderAddon_Orders_OrderId1",
                        column: x => x.OrderId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderAddon_AddonId",
                table: "OrderAddon",
                column: "AddonId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderAddon_OrderId1",
                table: "OrderAddon",
                column: "OrderId1");
